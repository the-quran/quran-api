...
export class TranslationInfoResolver {
  constructor(private readonly translationInfoService: TranslationInfoService) {}

  @Mutation(() => TranslationInfo)
  createTranslationInfo(@Args('createTranslationInfoInput') createTranslationInfoInput: CreateTranslationInfoInput) {
  ...
  @Mutation(() => TranslationInfo)
  updateTranslationInfo(@Args('updateTranslationInfoInput') updateTranslationInfoInput: UpdateTranslationInfoInput) {
    return this.translationInfoService.update(updateTranslationInfoInput.id, updateTranslationInfoInput);
  }
